...
var reverseObjects = function(inputArray) {
    var flippedArray = []
...
var criteriaMet = function(testObj, criteriaObj) {
    var metCriteria = false
    for(var key in criteriaObj) {
        if(criteriaObj[key] === testObj[key]) {
            metCriteria = true
        }
        else {
            metCriteria = false
